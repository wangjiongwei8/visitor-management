...
- [部署说明](docs/部署说明.zh-CN.md) — Docker / 本地部署、环境变量、初始化、备份升级
- [操作说明书](docs/操作说明书.zh-CN.md) — 访客 / 被访人 / 门卫 / 管理员分角色操作指引
- [设计总览](docs/总览.zh-CN.md) — 入口说明（功能说明、流程、决策）
- [产品需求文档](docs/PRD-访客管理系统.zh-CN.md)
- [架构设计](docs/ARCHITECTURE.zh-CN.md)
- [贡献指南](CONTRIBUTING.zh-CN.md) — 如何提 Issue / PR、开发环境、代码规范
...
- **Issue / PR**：Bug 报告与代码贡献请看 [CONTRIBUTING.zh-CN.md](CONTRIBUTING.zh-CN.md)。
